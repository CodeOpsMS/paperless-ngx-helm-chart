...
> Paperless-ngx 3.1.0 and is not the stable default. Chart `0.3.23`
> with Paperless-ngx `2.20.15` remains the production/stable release.

This experimental chart deploys Paperless-ngx 3.1.0 with optional PostgreSQL and
...
| `0.4.0-experimental.2` | `3.1.0` | Experimental Paperless 3 preview |
...
Experimental chart 0.4.0-experimental.2 is a breaking upgrade from Paperless-ngx 2.20.15 to 3.1.0. Do not
...
on Kubernetes 1.34-1.36 and Paperless 2.20.15-to-3.1.0 upgrades across Helm 3 and Helm 4.
...
| image.digest | string | `"sha256:49eba766581b9134cfa6b584b9eb718355fb9cfbd44b2a7c9c72a427d4891648"` | Immutable multi-platform image digest. When set, it overrides the tag. |
