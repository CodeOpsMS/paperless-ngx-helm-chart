...
> Paperless-ngx 3.1.1 and is not the stable default. Chart `0.3.23`
> with Paperless-ngx `2.20.15` remains the production/stable release.

This experimental chart deploys Paperless-ngx 3.1.1 with optional PostgreSQL and
...
| `0.4.0-experimental.2` | `3.1.1` | Experimental Paperless 3 preview |
...
Experimental chart 0.4.0-experimental.2 is a breaking upgrade from Paperless-ngx 2.20.15 to 3.1.1. Do not
...
on Kubernetes 1.34-1.36 and Paperless 2.20.15-to-3.1.1 upgrades across Helm 3 and Helm 4.
...
| image.digest | string | `"sha256:73a1d0bcc5b50cb501f084da795722aa5e2988c6bc9b26ca1ae493a57a490c06"` | Immutable multi-platform image digest. When set, it overrides the tag. |
