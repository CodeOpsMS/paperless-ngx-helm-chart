...
> Paperless-ngx 3.1.2 and is not the stable default. Chart `0.3.23`
> with Paperless-ngx `2.20.15` remains the production/stable release.

This experimental chart deploys Paperless-ngx 3.1.2 with optional PostgreSQL and
...
| `0.4.0-experimental.2` | `3.1.2` | Experimental Paperless 3 preview |
...
Experimental chart 0.4.0-experimental.2 is a breaking upgrade from Paperless-ngx 2.20.15 to 3.1.2. Do not
...
on Kubernetes 1.34-1.36 and Paperless 2.20.15-to-3.1.2 upgrades across Helm 3 and Helm 4.
...
| image.digest | string | `"sha256:5ab4f4f9bb099a36bec3e092906ea3e611323c5f18dc5cc38c76a1d540bdca9c"` | Immutable multi-platform image digest. When set, it overrides the tag. |
